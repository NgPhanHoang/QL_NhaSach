...
(
 ...
 INSERT INTO NGUOIDUNG VALUES(N'Nguyễn Phan Hoàng','admin', '123456','1234567899','083656578', N'Nam')
 INSERT INTO NGUOIDUNG VALUES(N'Nguyễn Anh Dương','nv01', '123456','2343412634','083726222', N'Nam')
...
(
	...
	CONSTRAINT FK_CTHDX_ND FOREIGN KEY (TAIKHOAN) REFERENCES NGUOIDUNG(TAIKHOAN),
)
...
-- Tạo đăng nhập và người dùng cho Nhanvien
...
GRANT SELECT, INSERT, UPDATE, DELETE ON HOADONNHAP TO [Nhanvien];
GRANT SELECT, INSERT, UPDATE, DELETE ON CTHOADONNHAP TO [Nhanvien];
GRANT SELECT, INSERT, UPDATE, DELETE ON HOADONXUAT TO [Nhanvien];
GRANT SELECT, INSERT, UPDATE, DELETE ON CTHOADONXUAT TO [Nhanvien];
GRANT SELECT ON NGUOIDUNG TO [Nhanvien];
GRANT REFERENCES ON SACH(MATG, MATL) TO [Nhanvien];
GRANT REFERENCES ON CTHOADONNHAP(MAHDN, MASACH) TO [Nhanvien];
GRANT REFERENCES ON CTHOADONXUAT(MAHDX, MASACH, TAIKHOAN) TO [Nhanvien];
